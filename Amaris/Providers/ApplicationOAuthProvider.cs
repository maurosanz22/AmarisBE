...
namespace Amaris.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        private ClaimsIdentity SetClaims(ApplicationUser user, string oAuthType, string userRole)
        {
            var oAuthIdentity = new ClaimsIdentity(oAuthType);
            
            oAuthIdentity.AddClaim(new Claim(ClaimTypes.Role.ToString(), userRole));
